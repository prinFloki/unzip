...
import com.compressor.extractor.compress.fileAdaptersForWork.FileAdapterItemsAllInOne;
import com.compressor.extractor.compress.fileAdaptersForWork.FileAdapterItemsAllInOneLiner;
        ...
        InterstitialAd.load(this, getResources().getString(R.string.admob_interstitial), adRequest,
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        //  mInterstitialAd.show(AllInOneCompress.this);
    ...
    private void runCommandextr(final String str) {
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void accept(Integer num) throws Exception {
                ...
                AllInOneCompress.this.showResult2(num);
            }
